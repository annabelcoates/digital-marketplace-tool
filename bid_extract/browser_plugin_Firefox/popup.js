...
document.getElementById("add").addEventListener('click', () => {
    function modifyDOM() {
        ...
        var contractLength = document.evaluate("/html[@class='govuk-template ']/body[@class='govuk-template__body  js-enabled']/div[@class='govuk-width-container ']/main[@id='main-content']/div[@class='govuk-grid-row'][2]/div[@class='govuk-grid-column-full']/dl[@class='govuk-summary-list app-govuk-summary-list app-govuk-summary-list--top-border govuk-!-margin-bottom-8'][2]/div[@class='govuk-summary-list__row'][4]/dd[@class='govuk-summary-list__value']/child::text()", document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue;
        var location = document.evaluate("/html[@class='govuk-template ']/body[@class='govuk-template__body  js-enabled']/div[@class='govuk-width-container ']/main[@id='main-content']/div[@class='govuk-grid-row'][2]/div[@class='govuk-grid-column-full']/dl[@class='govuk-summary-list app-govuk-summary-list app-govuk-summary-list--top-border govuk-!-margin-bottom-8'][2]/div[@class='govuk-summary-list__row'][5]/dd[@class='govuk-summary-list__value']/child::text()", document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue;
        var postedDate = document.evaluate("/html[@class='govuk-template ']/body[@class='govuk-template__body  js-enabled']/div[@class='govuk-width-container ']/main[@id='main-content']/div[@class='govuk-grid-row'][2]/div[@class='govuk-grid-column-full']/dl[@id='opportunity-important-dates']/div[@class='govuk-summary-list__row'][1]/dd[@class='govuk-summary-list__value']/child::text()", document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue;
        var closingDate = document.evaluate("/html[@class='govuk-template ']/body[@class='govuk-template__body  js-enabled']/div[@class='govuk-width-container ']/main[@id='main-content']/div[@class='govuk-grid-row'][2]/div[@class='govuk-grid-column-full']/dl[@id='opportunity-important-dates']/div[@class='govuk-summary-list__row'][3]/dd[@class='govuk-summary-list__value']/child::text()", document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue;
        var estimatedStartDate = document.evaluate("/html[@class='govuk-template ']/body[@class='govuk-template__body  js-enabled']/div[@class='govuk-width-container ']/main[@id='main-content']/div[@class='govuk-grid-row'][2]/div[@class='govuk-grid-column-full']/dl[@class='govuk-summary-list app-govuk-summary-list app-govuk-summary-list--top-border govuk-!-margin-bottom-8'][2]/div[@class='govuk-summary-list__row'][3]/dd[@class='govuk-summary-list__value']/child::text()", document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue;
